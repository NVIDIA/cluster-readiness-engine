...
var (
	...
	hardwareFailedJobsTotal = prometheus.NewCounterVec(
		prometheus.CounterOpts{
			Name: "burnin_hardware_failed_jobs_total",
	...
	nodeHealthCheckDuration = prometheus.NewHistogramVec(
		prometheus.HistogramOpts{
			Name:    "burnin_node_health_check_duration_seconds",
	...
	nodesEvaluatedTotal = prometheus.NewCounterVec(
		prometheus.CounterOpts{
			Name: "burnin_nodes_evaluated_total",
	...
	hardwareFailuresDetectedTotal = prometheus.NewCounterVec(
		prometheus.CounterOpts{
			Name: "burnin_hardware_failures_detected_total",
	...
	reconcileDuration = prometheus.NewHistogramVec(
		prometheus.HistogramOpts{
			Name:    "burnin_reconcile_duration_seconds",
	...
	workloadCreatedTotal = prometheus.NewCounterVec(
		prometheus.CounterOpts{
			Name: "burnin_workload_created_total",
	...
	goodputAvgTFLOPSGauge = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			Name: "burnin_goodput_avg_tflops_per_gpu",
	...
	goodputRescheduleTimeGauge = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			Name: "burnin_goodput_reschedule_time_seconds",
	...
	goodputResumeTimeGauge = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			Name: "burnin_goodput_resume_time_seconds",
	...
	goodputCheckpointSaveTimeGauge = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			Name: "burnin_goodput_checkpoint_save_time_seconds",
	...
	goodputLostWorkTimeGauge = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			Name: "burnin_goodput_lost_work_time_seconds",
	...
	goodputTrainingTimeGauge = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			Name: "burnin_goodput_training_time_seconds",
	...
	goodputWarmupTimeGauge = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			Name: "burnin_goodput_warmup_time_seconds",
	...
	goodputNonWarmupTimeGauge = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			Name: "burnin_goodput_non_warmup_time_seconds",
	...
	goodputAvgStepTimeGauge = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			Name: "burnin_goodput_avg_step_time_seconds",
	...
	topologyValidatedNodesGauge = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			Name: "burnin_topology_validated_nodes",
	...
	topologyFailedNodesGauge = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			Name: "burnin_topology_failed_nodes",
...
// cleanupJobMetrics removes all metrics associated with a deleted job.
func cleanupJobMetrics(namespace, jobName, workflow string) {
	// Delete job status gauges
	for _, status := range []string{"in_progress", "succeeded", "failed"} {
		jobStatusGauge.DeleteLabelValues(namespace, jobName, workflow, status)
	}

	// Delete failed nodes gauge
	failedNodesGauge.DeleteLabelValues(namespace, jobName, workflow)

	// Note: We don't delete counters (hardwareFailedJobsTotal, nodesEvaluatedTotal, etc.)
	// as they represent cumulative totals that should persist for observability
}
