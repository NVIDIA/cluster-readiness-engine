...
// DefaultHealthExpression is the standard CEL expression for node health monitoring.
// All catalog YAML entries should use this expression for consistency.
const DefaultHealthExpression = `node.spec.unschedulable == true`
