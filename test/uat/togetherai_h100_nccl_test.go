...
func TestTogetherAIH100NCCL(t *testing.T) {
	const (
		certName = "togetherai-h100-nccl"
		nodesDir = "testdata/togetherai/h100"
		dataDir  = "testdata/togetherai/h100/nccl"
	)

	feature := features.New("togetherai/h100/nccl-all-reduce").
