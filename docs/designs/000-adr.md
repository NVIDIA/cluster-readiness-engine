# ADR-0022: CRE Architecture for GPU Cluster Certification
...
│  ├─ GpuNvlinkWatch: False             └─ validation.dgxc.nvidia.com/...  │
│  └─ cre.nvidia.com/                                                   │
