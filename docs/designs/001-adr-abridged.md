...
- **No automation path.** New models and recipes must be added manually. A controller with a catalog API enables downstream systems (e.g., LLMB) to register and trigger certifications programmatically.
