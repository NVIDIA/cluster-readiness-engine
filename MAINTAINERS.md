...
| Name | GitHub | Areas |
|---|---|---|
| Ebot Ndip-Agbor | [@ndipebot](https://github.com/ndipebot) | Project-wide: controllers (`pkg/controller/`), catalog (`pkg/catalog/`), workload adapters (`pkg/workload/`), CLI (`cmd/nvcrectl/`), Helm chart (`helm/`), CI |
| Lalit Adithya | [@lalitadithya](https://github.com/lalitadithya) | Project-wide: controllers (`pkg/controller/`), catalog (`pkg/catalog/`), workload adapters (`pkg/workload/`), CLI (`cmd/nvcrectl/`), Helm chart (`helm/`), CI |
